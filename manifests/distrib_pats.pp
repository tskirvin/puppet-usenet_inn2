# usenet_inn2::distrib_pats
#
#   Create and manage /etc/news/distrib.pats (or similar).  This file is used
#   to set the default value of the Distribution: header, depending on
#   hierarchy.
#
#   The underlying file is managed with the 'concat' module.  Stanzas are
#   created using the usenet_inn2::distib_pats::fragment definition.
#
