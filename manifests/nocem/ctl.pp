# Create and manage /etc/news/nocem.ctl (or similar).  This file is used to 
# decide which nocem messages to honor.
#
# The underlying file is managed with the 'concat' module.  Stanzas are created
# using the usenet_inn2::nocem::fragment definition.
# 
